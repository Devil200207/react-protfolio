    ...
    <footer className="bg-black border-t border-gray-800 py-12 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          >
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-emerald-500 mb-4">
              Portfolio
            </h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Creating exceptional digital experiences through creative development and innovative solutions.
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-400 hover:text-white transition-colors">E-commerce</a>
              </li>
              <li>
